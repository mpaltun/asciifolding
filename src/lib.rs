...
mod tests {
    ...
    fn test_latin1_accents() {
        ...
        for (input, expected) in foldings {
            assert_eq!(fold_to_ascii(input), expected)
        }
    }
    ...
    fn test_unmodified_letters() {
        ...
        assert_eq!(fold_to_ascii("¦"), "¦");
        assert_eq!(fold_to_ascii("¤"), "¤");
        assert_eq!(fold_to_ascii("END"), "END");
    }

    #[test]
    fn test_all_foldings() {
        let foldings = vec![
            (r#"ÀÁÂÃÄÅĀĂĄƏǍǞǠǺȀȂȦȺᴀḀẠẢẤẦẨẪẬẮẰẲẴẶⒶＡ"#, r#"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"#),
            (r#"àáâãäåāăąǎǟǡǻȁȃȧɐəɚᶏḁᶕẚạảấầẩẫậắằẳẵặₐₔⓐⱥⱯａ"#, r#"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"#),
            (r#"Ꜳ"#, r#"AA"#),
            (r#"ÆǢǼᴁ"#, r#"AEAEAEAE"#),
            (r#"Ꜵ"#, r#"AO"#),
            (r#"Ꜷ"#, r#"AU"#),
            ...
            (r#"⒞"#, r#"(c)"#),
            (r#"ÐĎĐƉƊƋᴅᴆḊḌḎḐḒⒹꝹＤ"#, r#"DDDDDDDDDDDDDDDD"#),
            (r#"ðďđƌȡɖɗᵭᶁᶑḋḍḏḑḓⓓꝺｄ"#, r#"dddddddddddddddddd"#),
            (r#"ǄǱ"#, r#"DZDZ"#),
            (r#"ǅǲ"#, r#"DzDz"#),
            (r#"⒟"#, r#"(d)"#),
            (r#"ȸ"#, r#"db"#),
            (r#"ǆǳʣʥ"#, r#"dzdzdzdz"#),
            (r#"ÈÉÊËĒĔĖĘĚƎƐȄȆȨɆᴇḔḖḘḚḜẸẺẼẾỀỂỄỆⒺⱻＥ"#, r#"EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE"#),
            (r#"èéêëēĕėęěǝȅȇȩɇɘɛɜɝɞʚᴈᶒᶓᶔḕḗḙḛḝẹẻẽếềểễệₑⓔⱸｅ"#, r#"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"#),
            (r#"⒠"#, r#"(e)"#),
            (r#"ƑḞⒻꜰꝻꟻＦ"#, r#"FFFFFFF"#),
            ...
            (r#"ﬁ"#, r#"fi"#),
            (r#"ﬂ"#, r#"fl"#),
            (r#"ĜĞĠĢƓǤǥǦǧǴɢʛḠⒼꝽꝾＧ"#, r#"GGGGGGGGGGGGGGGGG"#),
            (r#"ĝğġģǵɠɡᵷᵹᶃḡⓖꝿｇ"#, r#"gggggggggggggg"#),
            (r#"⒢"#, r#"(g)"#),
            (r#"ĤĦȞʜḢḤḦḨḪⒽⱧⱵＨ"#, r#"HHHHHHHHHHHHH"#),
            (r#"ĥħȟɥɦʮʯḣḥḧḩḫẖⓗⱨⱶｈ"#, r#"hhhhhhhhhhhhhhhhh"#),
            (r#"Ƕ"#, r#"HV"#),
            (r#"⒣"#, r#"(h)"#),
            (r#"ƕ"#, r#"hv"#),
            (r#"ÌÍÎÏĨĪĬĮİƖƗǏȈȊɪᵻḬḮỈỊⒾꟾＩ"#, r#"IIIIIIIIIIIIIIIIIIIIIII"#),
            (r#"ìíîïĩīĭįıǐȉȋɨᴉᵢᵼᶖḭḯỉịⁱⓘｉ"#, r#"iiiiiiiiiiiiiiiiiiiiiiii"#),
            (r#"Ĳ"#, r#"IJ"#),
            (r#"⒤"#, r#"(i)"#),
            (r#"ĳ"#, r#"ij"#),
            (r#"ĴɈᴊⒿＪ"#, r#"JJJJJ"#),
            ...
            (r#"⒥"#, r#"(j)"#),
            (r#"ĶƘǨᴋḰḲḴⓀⱩꝀꝂꝄＫ"#, r#"KKKKKKKKKKKKK"#),
            (r#"ķƙǩʞᶄḱḳḵⓚⱪꝁꝃꝅｋ"#, r#"kkkkkkkkkkkkkk"#),
            (r#"⒦"#, r#"(k)"#),
            (r#"ĹĻĽĿŁȽʟᴌḶḸḺḼⓁⱠⱢꝆꝈꞀＬ"#, r#"LLLLLLLLLLLLLLLLLLL"#),
            (r#"ĺļľŀłƚȴɫɬɭᶅḷḹḻḽⓛⱡꝇꝉꞁｌ"#, r#"lllllllllllllllllllll"#),
            (r#"Ǉ"#, r#"LJ"#),
            (r#"Ỻ"#, r#"LL"#),
            (r#"ǈ"#, r#"Lj"#),
            (r#"⒧"#, r#"(l)"#),
            ...
            (r#"⒨"#, r#"(m)"#),
            (r#"ÑŃŅŇŊƝǸȠɴᴎṄṆṈṊⓃＮ"#, r#"NNNNNNNNNNNNNNNN"#),
            (r#"ñńņňŉŋƞǹȵɲɳᵰᶇṅṇṉṋⁿⓝｎ"#, r#"nnnnnnnnnnnnnnnnnnnn"#),
            (r#"Ǌ"#, r#"NJ"#),
            (r#"ǋ"#, r#"Nj"#),
            (r#"⒩"#, r#"(n)"#),
            (r#"ǌ"#, r#"nj"#),
            (r#"ÒÓÔÕÖØŌŎŐƆƟƠǑǪǬǾȌȎȪȬȮȰᴏᴐṌṎṐṒỌỎỐỒỔỖỘỚỜỞỠỢⓄꝊꝌＯ"#, r#"OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO"#),
            (r#"òóôõöøōŏőơǒǫǭǿȍȏȫȭȯȱɔɵᴖᴗᶗṍṏṑṓọỏốồổỗộớờởỡợₒⓞⱺꝋꝍｏ"#, r#"ooooooooooooooooooooooooooooooooooooooooooooooo"#),
            (r#"Œɶ"#, r#"OEOE"#),
            (r#"Ꝏ"#, r#"OO"#),
            (r#"Ȣᴕ"#, r#"OUOU"#),
            (r#"⒪"#, r#"(o)"#),
            ...
            (r#"⒬"#, r#"(q)"#),
            (r#"ȹ"#, r#"qp"#),
            (r#"ŔŖŘȐȒɌʀʁᴙᴚṘṚṜṞⓇⱤꝚꞂＲ"#, r#"RRRRRRRRRRRRRRRRRRR"#),
            (r#"ŕŗřȑȓɍɼɽɾɿᵣᵲᵳᶉṙṛṝṟⓡꝛꞃｒ"#, r#"rrrrrrrrrrrrrrrrrrrrrr"#),
            (r#"⒭"#, r#"(r)"#),
            (r#"ŚŜŞŠȘṠṢṤṦṨⓈꜱꞅＳ"#, r#"SSSSSSSSSSSSSS"#),
            (r#"śŝşšſșȿʂᵴᶊṡṣṥṧṩẜẝⓢꞄｓ"#, r#"ssssssssssssssssssss"#),
            (r#"ẞ"#, r#"SS"#),
            (r#"⒮"#, r#"(s)"#),
            (r#"ß"#, r#"ss"#),
            (r#"ﬆ"#, r#"st"#),
            (r#"ŢŤŦƬƮȚȾᴛṪṬṮṰⓉꞆＴ"#, r#"TTTTTTTTTTTTTTT"#),
            (r#"ţťŧƫƭțȶʇʈᵵṫṭṯṱẗⓣⱦｔ"#, r#"tttttttttttttttttt"#),
            (r#"ÞꝦ"#, r#"THTH"#),
            (r#"Ꜩ"#, r#"TZ"#),
            (r#"⒯"#, r#"(t)"#),
            (r#"ʨ"#, r#"tc"#),
            ...
            (r#"ʦ"#, r#"ts"#),
            (r#"ꜩ"#, r#"tz"#),
            (r#"ÙÚÛÜŨŪŬŮŰŲƯǓǕǗǙǛȔȖɄᴜᵾṲṴṶṸṺỤỦỨỪỬỮỰⓊＵ"#, r#"UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU"#),
            (r#"ùúûüũūŭůűųưǔǖǘǚǜȕȗʉᵤᶙṳṵṷṹṻụủứừửữựⓤｕ"#, r#"uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu"#),
            (r#"⒰"#, r#"(u)"#),
            (r#"ᵫ"#, r#"ue"#),
            ...
            (r#"ᶍẋẍₓⓧｘ"#, r#"xxxxxx"#),
            (r#"⒳"#, r#"(x)"#),
            (r#"ÝŶŸƳȲɎʏẎỲỴỶỸỾⓎＹ"#, r#"YYYYYYYYYYYYYYY"#),
            (r#"ýÿŷƴȳɏʎẏẙỳỵỷỹỿⓨｙ"#, r#"yyyyyyyyyyyyyyyy"#),
            (r#"⒴"#, r#"(y)"#),
            (r#"ŹŻŽƵȜȤᴢẐẒẔⓏⱫꝢＺ"#, r#"ZZZZZZZZZZZZZZ"#),
            (r#"źżžƶȝȥɀʐʑᵶᶎẑẓẕⓩⱬꝣｚ"#, r#"zzzzzzzzzzzzzzzzzz"#),
            (r#"⒵"#, r#"(z)"#),
            (r#"⁰₀⓪⓿０"#, r#"00000"#),
            (r#"¹₁①⓵❶➀➊１"#, r#"11111111"#),
            (r#"⒈"#, r#"1."#),
